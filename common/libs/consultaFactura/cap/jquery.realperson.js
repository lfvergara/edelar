...
function RealPerson() {
	this._defaults = {
		...
		regenerate: 'Actualizar', // Instruction text to regenerate
...
$.extend(RealPerson.prototype, {
	...
	_generateHTML: function(target, inst) {
		...
		var html = '<div class="' + this.propertyName + '-challenge" >' +
			'<div class="' + this.propertyName + '-text" style=" float: left;">';
		...
		html += '</div><div class="' + this.propertyName + '-regen" style=" float: right;">' + inst.options.regenerate +
